...
```{r}
#Bar chart show distribution among State
...
Removing outliers that spread the graph by limited the x-axis by removing 0.05% of the points furthest away from the median.

When APR increases as the rating gets riskier and most people tend to have debt-to-income ratios below 1, regardless of risk category.Also, there is this unusual horizontal line in the 'HR' category that extends past 1 and all the way to
------
